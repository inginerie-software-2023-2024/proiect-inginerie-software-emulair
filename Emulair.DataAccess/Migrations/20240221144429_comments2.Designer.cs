...
namespace Emulair.DataAccess.Migrations
{
    ...
    [Migration("20240221144429_comments2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmulairWEB.Models.Achievement", b =>
                {
                    ...
                    b.HasIndex(new[] { "GameId" }, "IX_Achievements_GameID");

                    b.HasIndex(new[] { "IconCompletedId" }, "IX_Achievements_IconCompletedID");

                    b.HasIndex(new[] { "IconPendingId" }, "IX_Achievements_IconPendingID");
            ...
            modelBuilder.Entity("EmulairWEB.Models.NewsImage", b =>
                {
                    ...
                    b.HasIndex(new[] { "ImageId" }, "IX_NewsImage_ImageId");

                    b.HasIndex(new[] { "NewsId" }, "IX_NewsImage_NewsId");
            ...
            modelBuilder.Entity("EmulairWEB.Models.Stat", b =>
                {
                    ...
                    b.HasIndex(new[] { "GameId" }, "IX_Stats_GameID");
            ...
            modelBuilder.Entity("EmulairWEB.Models.UserAchievement", b =>
                {
                    ...
                    b.HasIndex(new[] { "AchievementId", "GameId" }, "IX_UserAchievements_AchievementID_GameID");

                    b.HasIndex(new[] { "UserId" }, "IX_UserAchievements_UserID");
            ...
            modelBuilder.Entity("EmulairWEB.Models.UserGame", b =>
                {
                    ...
                    b.HasIndex(new[] { "GameId" }, "IX_UserGames_GameID");
            ...
            modelBuilder.Entity("EmulairWEB.Models.UserStat", b =>
                {
                    ...
                    b.HasIndex(new[] { "UserId" }, "IX_UserStats_UserID");
            ...
            modelBuilder.Entity("EmulairWEB.Models.Game", b =>
                {
                    b.HasOne("EmulairWEB.Models.Image", "Icon")
                        .WithMany("Games")
